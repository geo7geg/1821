...
namespace StrategyGame
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string username)
        {
            ...
            if(username == "Kolokotrwnis")
            {
                pictureBox2.BackgroundImage = new Bitmap(WindowsFormsApplication2.Properties.Resources.kolokotronis);
            }
            else if (username == "Mpoumpoulina")
            {
                pictureBox2.BackgroundImage = new Bitmap(WindowsFormsApplication2.Properties.Resources.mpoumpoulina);
            }
            else if (username == "Papaflessas")
            {
                pictureBox2.BackgroundImage = new Bitmap(WindowsFormsApplication2.Properties.Resources.papaflessas);
            }
            else if (username == "Lontos")
            {
                pictureBox2.BackgroundImage = new Bitmap(WindowsFormsApplication2.Properties.Resources.lontos);
            }
            else if (username == "Mauromixalis")
            {
                pictureBox2.BackgroundImage = new Bitmap(WindowsFormsApplication2.Properties.Resources.mauromixalis);
            }
        ...
        public void DrawMap()
        {
            ...
            for (int j = 1; j <= num_cit; j++)
            {
                ...
                else
                {
                    ...
                    LB.Font = new Font("Calibri", 15, FontStyle.Bold);
                    //LB.Text = temp3;
                    LB.Image = new Bitmap(WindowsFormsApplication2.Properties.Resources.castle1);
                    LB.Click += new EventHandler(LB_Click); //assign click handler
                    LB.MouseHover += new EventHandler(LB_MouseHover);
                    LB.MouseLeave += new EventHandler(LB_MouseLeave);
        ...
        {
            login_player(Convert.ToString(comboBox1.SelectedItem));
        }
    }
}
